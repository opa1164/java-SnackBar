...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("Jane's cash on hand is $%,.2f%n", jane.getCashOnHand());
        ...
        System.out.printf("Bob's cash on hand is $%,.2f%n", bob.getCashOnHand());
        System.out.println("Quantity of soda is " + soda.getQuantity() + "\n");
        ...
        System.out.printf("Jane's cash on hand is $%,.2f", jane.getCashOnHand());
